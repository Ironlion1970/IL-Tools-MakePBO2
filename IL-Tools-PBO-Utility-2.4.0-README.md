...
1. Run `IL-Tools-PBO-Utility-2.4.0.exe`
...
```
IL-Tools-PBO-Utility-2.4.0.exe
IL-Tools-PBO-Utility-2.4.0.exe pack C:\Work\natofix -o natofix.pbo --product "OFP: Resistance" --no-compress
IL-Tools-PBO-Utility-2.4.0.exe pack C:\Work\MyMission -o MyMission.pbo --no-compress
IL-Tools-PBO-Utility-2.4.0.exe unpack MyMission.pbo
IL-Tools-PBO-Utility-2.4.0.exe unpack MyMission.pbo -o C:\Work\MyMission
IL-Tools-PBO-Utility-2.4.0.exe inspect MyMission.pbo
```
